...
export interface DefaultOperatorFiltererInterface extends Interface {
  getFunction(nameOrSignature: "OPERATOR_FILTER_REGISTRY"): FunctionFragment;
...
export interface DefaultOperatorFilterer extends BaseContract {
  connect(runner?: ContractRunner | null): DefaultOperatorFilterer;
