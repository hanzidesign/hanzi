# Phase 5W — reference editor Wave Lines parity
...
Wave Lines is WebGPU-only in reference editor. WebGL passes through the source and still runs Bloom/Post. Hanzi Studio keeps the selected 3D Character input.
