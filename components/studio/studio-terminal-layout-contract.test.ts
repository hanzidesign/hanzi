...
describe('Phase 5D Grainrad terminal Studio layout contract', () => {
  ...
  it('has dedicated desktop panels, mobile tabs, and a mobile settings sheet', async () => {
    ...
    expect(rightPanel).toContain("group.title === 'Adjustments'")
    expect(rightPanel).toContain('className={`${classes.inputGroupReset} ${classes.adjustmentsReset}`}')
    ...
    expect(shellStyles).toContain('.adjustmentsReset')
    ...
    expect(rightPanel).toContain('Reset all')
