...
} from '@/components/studio/pixel-sort-material'
...
function CharacterPixelSortScene({
  ...
  const material = useMemo(() => createPixelSortShaderMaterial({
    controls: {},
  ...
  useEffect(() => {
applyPixelSortUniforms(material, withoutSharedControllerValues(controls))
  }, [controls, material])
