...
function CharacterEdgeDetectionScene({
  ...
  const controls = useStudioStore((store) => store.grainradEffect.controls['edge-detection'])
  ...
  useEffect(() => {
    const nextSource = geometryResult ? createEdgeDetectionSourceScene(geometryResult) : null
